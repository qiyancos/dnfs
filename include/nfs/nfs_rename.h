...
bool xdr_RENAME3args(XDR *, RENAME3args *);

bool xdr_RENAME3resok(XDR *, RENAME3resok *);

bool xdr_RENAME3resfail(XDR *, RENAME3resfail *);

bool xdr_RENAME3res(XDR *, RENAME3res *);
